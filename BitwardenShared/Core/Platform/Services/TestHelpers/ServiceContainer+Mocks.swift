...
extension ServiceContainer {
    ...
    static func withMocks( // swiftlint:disable:this function_body_length
        ...
        backgroundSessionCleanupService: BackgroundSessionCleanupService = MockBackgroundSessionCleanupService(),
        backgroundTaskScheduler: BackgroundTaskScheduler? = MockBackgroundTaskScheduler(),
