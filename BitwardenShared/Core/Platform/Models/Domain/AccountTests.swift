...
class AccountTests: BitwardenTestCase {
    ...
    func test_kdfConfig_defaults() throws {
        ...
        XCTAssertEqual(subject.kdf, KdfConfig(kdfType: .pbkdf2sha256, kdfIterations: 600_000))
    }
    ...
    func test_kdfConfig_values() throws {
        ...
        XCTAssertEqual(
            subject.kdf,
            KdfConfig(kdfType: .argon2id, kdfIterations: 1_000_000, kdfMemory: 64, kdfParallelism: 4)
        )
    }
