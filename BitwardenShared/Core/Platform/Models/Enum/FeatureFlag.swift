...
extension FeatureFlag {
    ...
    static let enableCipherKeyEncryption = FeatureFlag(rawValue: "enable-cipher-key-encryption")
    ...
    static let ignore2FANoticeEnvironmentCheck = FeatureFlag(rawValue: "ignore-2fa-notice-environment-check")
    ...
    static let restrictCipherItemDeletion = FeatureFlag(rawValue: "pm-15493-restrict-item-deletion-to-can-manage-permission")
