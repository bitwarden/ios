...
public extension DeviceAuthKeyKeychainMetadata {
    ...
    /// - Returns: A `DeviceAuthKeyKeychainMetadata` configured with the specified or default values.
    static func fixture(
