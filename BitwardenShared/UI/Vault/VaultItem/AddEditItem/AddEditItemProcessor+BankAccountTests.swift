...
@MainActor
struct AddEditItemProcessorBankAccountTests {
    // MARK: Properties

    let authRepository: MockAuthRepository
    let appExtensionDelegate: MockAppExtensionDelegate
    let billingRepository: MockBillingRepository
    let billingService: MockBillingService
    let cameraService: MockCameraService
    let cardTextParser: MockCardTextParser
    ...
    let rehydrationHelper: MockRehydrationHelper
    ...
    let subject: AddEditItemProcessor
    let vaultItemActionHelper: MockVaultItemActionHelper
    ...
    @Test
    func receive_bankAccountFieldChanged_bankNameChanged() {
        ...
        #expect(subject.state.bankAccountItemState.bankName == "Bank of America")
    }

    /// `receive(_:)` with `.bankAccountFieldChanged(.nameOnAccountChanged)` updates the state correctly.
    @Test
    func receive_bankAccountFieldChanged_nameOnAccountChanged() {
        ...
        #expect(subject.state.bankAccountItemState.nameOnAccount == "Personal Checking")
    }

    /// `receive(_:)` with `.bankAccountFieldChanged(.accountTypeChanged)` updates the state correctly.
    @Test
    func receive_bankAccountFieldChanged_accountTypeChanged() {
    ...
    func receive_bankAccountFieldChanged_accountNumberChanged() {
        ...
        #expect(subject.state.bankAccountItemState.accountNumber == "1234567890123456")
    }

    /// `receive(_:)` with `.bankAccountFieldChanged(.routingNumberChanged)` updates the state correctly.
    @Test
    func receive_bankAccountFieldChanged_routingNumberChanged() {
    ...
    func receive_bankAccountFieldChanged_bankContactPhoneChanged() {
        ...
        #expect(subject.state.bankAccountItemState.bankContactPhone == "123-456-7890")
    }

    /// `receive(_:)` with `.bankAccountFieldChanged(.toggleAccountNumberVisibilityChanged)` updates
    /// the state correctly.
    @Test
    func receive_bankAccountFieldChanged_toggleAccountNumberVisibilityChanged() {
        ...
        #expect(subject.state.bankAccountItemState.isAccountNumberVisible)
    ...
    @Test
    func receive_bankAccountFieldChanged_togglePinVisibilityChanged() {
        ...
        #expect(subject.state.bankAccountItemState.isPinVisible)
    ...
    @Test
    func receive_bankAccountFieldChanged_toggleIbanVisibilityChanged() {
        ...
        #expect(subject.state.bankAccountItemState.isIbanVisible)
