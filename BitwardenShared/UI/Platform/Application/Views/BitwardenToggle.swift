...
struct BitwardenToggle<FooterContent: View>: View {
    ...
    /// The footer content displayed below the toggle. This can be used for customized content than
    /// just plain text. The `footer` string will take precedence over this if provided.
