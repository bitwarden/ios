...
extension UIColor {
    ...
    /// Conveniently initializes a UIColor using a hex value.
    ///
    ...
    /// Determines whether a UIColor is considered light based off of its luminance.
    ///
    /// When a light color is used as a background, the overlaid text should be dark.
    ///
    /// - Returns: Whether a UIColor is considered light based off of its luminance.
    ///
    func isLight() -> Bool {
