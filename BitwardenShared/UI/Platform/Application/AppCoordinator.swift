...
class AppCoordinator: Coordinator, HasRootNavigator {
    ...
    private func showSSOSyncError() {
        ...
        globalModalCoordinator.navigate(to: .ssoSyncError, context: self)
