...
class TestDeleteUnusedContent(unittest.TestCase):
    ...
    def test_block_comment_before_unused_key_is_removed(self):
        content = (
            '"About" = "About";\n'
            '/* This key is unused */\n'
            '"UnusedKey" = "Unused";\n'
    ...
    def test_line_comment_before_unused_key_is_removed(self):
        content = (
            '"About" = "About";\n'
            '// unused\n'
            '"UnusedKey" = "Unused";\n'
    ...
    def test_multiline_block_comment_before_unused_key_is_removed(self):
        content = (
            '"About" = "About";\n'
            '/* This comment\n'
    ...
    def test_comment_before_used_key_is_preserved(self):
        content = (
            '/* Section header */\n'
            '"About" = "About";\n'
            '"UnusedKey" = "Unused";\n'
    ...
    def test_blank_line_between_comment_and_unused_key_preserves_comment(self):
        content = (
            '"About" = "About";\n'
            '/* Orphaned comment */\n'
            '\n'
    ...
    def test_blank_lines_in_file_are_preserved(self):
        content = (
            '"About" = "About";\n'
            '\n'
            '"Cancel" = "Cancel";\n'
